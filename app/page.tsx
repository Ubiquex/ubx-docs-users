...
import { NAV, TABS, SECTIONS, PROVIDER_SITE, FOOTER } from "@/lib/site";
...
export default function Home() {
  return (
    <PageShell
      ...
      footer={FOOTER}
    >
      {/* Centred, matching the provider site's own landing page. This
          block was left-aligned while the cards below it were a centred
          grid, so the heading sat off to one side of its own content. */}
